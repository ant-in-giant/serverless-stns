...
resource aws_api_gateway_deployment "api" {
  ...
  stage_description = "Terraform hash ${md5("${filemd5("${path.module}/api-resources.tf")}${var.api_policy_json}")}"
  description       = "Terraform hash ${md5("${filemd5("${path.module}/api-resources.tf")}${var.api_policy_json}")}"
}
